  ...
  return (
    <div className="section-features flat-spacing">
      <div className="container">
        ...
        <div className="row">
          {values.map((value) => (
            <div key={value.id} className={value.colClass}>
              <div 
                className="features-item style-2 h-100 effectFade fadeRotateX" 
              ...
              >
                <div className="features-header-wrap">
                  ...
                  <h4 className="title fw-semibold">{value.title}</h4>
                </div>
      ...
      {activeValue && (
        <div className="value-modal-overlay" onClick={() => setActiveValue(null)}>
          <div className="value-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <h3 className="value-modal-title">{activeValue.title}</h3>
            <p className="value-modal-desc">{activeValue.desc}</p>
          </div>
        </div>
      )}
      ...
      <style>{`
        ...
        .value-modal-overlay {
          ...
          z-index: 99999;
          padding: 20px;
          animation: valueModalFadeIn 0.3s ease-out;
        }
        ...
        .value-modal-card {
          ...
          animation: valueModalSlideUp 0.3s cubic-bezier(0.34, 1.56, 0.64, 1);
          text-align: center;
        }
        ...
        @keyframes valueModalFadeIn {
          from { opacity: 0; }
          to { opacity: 1; }
        }

        @keyframes valueModalSlideUp {
          from {
            opacity: 0;
