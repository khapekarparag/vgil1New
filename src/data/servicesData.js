...
export const SERVICES_DATA = [
  {
    ...
    longDescription: 'Professional application development services for all types of websites and mobile apps. Transform your digital presence with our custom development solutions.',
    keyDeliverables: [
