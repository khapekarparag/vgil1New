                    ...
                    <div className="thumbnail-wrapper" style={{
                      ...
                      {doc.thumbnail ? (
                        <div style={{
                          width: '100%',
                          height: '100%',
                          background: `url(${doc.thumbnail}) center/cover no-repeat`,
                          position: 'relative'
                        }}>
                          <div style={{ position: 'absolute', bottom: '0', left: '0', right: '0', height: '4px', background: '#ff2d15' }}></div>
                        </div>
                      ) : (
                        <img src={vgilLogo} alt="VGI" style={{ width: '80%', height: 'auto', opacity: '0.5' }} />
                      )}
                    </div>
                    <div style={{ 
                      width: '40px', 
                      ...
                      <i className="icon icon-file-alt-solid" style={{ fontSize: '16px', color: '#111827' }}></i>
                    </div>
                  </div>
